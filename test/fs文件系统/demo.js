...
fs.chown(path, uid, gid, callback)/fs.chownSync(path, uid, gid)
...
fs.fstat(fd, callback)/fs.statSync(path)
fs.lstatSync(path)/fs.fstatSync(fd)
fs.link(srcpath, dstpath, callback)/fs.linkSync(srcpath, dstpath)
fs.symlink(srcpath, dstpath[, type], callback)fs.symlinkSync(srcpath, dstpath[, type])
...
fs.write(fd, data[, position[, encoding]], callback)/fs.writeSync(fd, data[, position[, encoding]])
